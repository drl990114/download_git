...
pub fn parse_shortcut_url(url: &str) -> Result<GitUrl, GitDownError> {
    let regex = Regex::new(
...
pub fn resolve_url_host_alias(alias: &str) -> Result<String, GitDownError> {
...
pub fn read_url_part(captures: &Captures, name: &str) -> Result<String, GitDownError> {
...
pub fn parse_http_url(url: &str) -> Result<GitUrl, GitDownError> {
